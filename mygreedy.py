...
class _EpsilonGreedy(BaseMAB):
    ...
    def _copy_arms(self, cold_arm_to_warm_arm):
        print("copy")
        print(f"cold_arm_to_warm_arm:{cold_arm_to_warm_arm}")
        for cold_arm, warm_arm in cold_arm_to_warm_arm.items():
            print(f"cold:{cold_arm}, warm:{warm_arm}")
    ...
    def _uptake_new_arm(self, arm: Arm, binarizer: Callable = None, scaler: Callable = None):
        ...
        # print(f"arm_to_sum: {self.arm_to_sum[1]}, arm_to_count:{self.arm_to_count[1]}, arm_to_expectation:{self.arm_to_expectation[1]}")
